...
class YearlyDateTimeIntervalTest
{
    ...
    {
        assertEquals("01.01.2021 00:00:00.000", dateTimeFormatter.print(dateTimeInterval.fromDateTime))
        assertEquals("31.12.2021 23:59:59.999", dateTimeFormatter.print(dateTimeInterval.toDateTime))
    }
    ...
    fun testIntervalShifting()
    {
        ...
        assertEquals("01.01.2022 00:00:00.000", dateTimeFormatter.print(_2022.fromDateTime))
        assertEquals("31.12.2022 23:59:59.999", dateTimeFormatter.print(_2022.toDateTime))
        assertEquals("2022", _2022.toString(mockResources))

        val _2023=dateTimeInterval.getShiftedDateTimeInterval(2)!!
        assertEquals("01.01.2023 00:00:00.000", dateTimeFormatter.print(_2023.fromDateTime))
        assertEquals("31.12.2023 23:59:59.999", dateTimeFormatter.print(_2023.toDateTime))
        assertEquals("2023", _2023.toString(mockResources))

        val _2020=dateTimeInterval.getPreviousDateTimeInterval()!!
        assertEquals("01.01.2020 00:00:00.000", dateTimeFormatter.print(_2020.fromDateTime))
        assertEquals("31.12.2020 23:59:59.999", dateTimeFormatter.print(_2020.toDateTime))
        assertEquals("2020", _2020.toString(mockResources))

        val _2019=dateTimeInterval.getShiftedDateTimeInterval(-2)!!
        assertEquals("01.01.2019 00:00:00.000", dateTimeFormatter.print(_2019.fromDateTime))
        assertEquals("31.12.2019 23:59:59.999", dateTimeFormatter.print(_2019.toDateTime))
    ...
    fun testIntervalAroundToday()
    {
        ...
        assertEquals("01.01.$year 00:00:00.000", dateTimeFormatter.print(interval.fromDateTime))
        assertEquals("31.12.$year 23:59:59.999", dateTimeFormatter.print(interval.toDateTime))
