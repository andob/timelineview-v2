...
class MonthlyDateTimeIntervalTest
{
    ...
    {
        assertEquals("01.01.2006 00:00:00.000", dateTimeFormatter.formatJodaDateTime(dateTimeInterval.fromDateTime))
        assertEquals("31.01.2006 23:59:59.999", dateTimeFormatter.formatJodaDateTime(dateTimeInterval.toDateTime))
    }
    ...
    fun testIntervalShifting()
    {
        ...
        assertEquals("01.02.2006 00:00:00.000", dateTimeFormatter.formatJodaDateTime(february2006.fromDateTime))
        assertEquals("28.02.2006 23:59:59.999", dateTimeFormatter.formatJodaDateTime(february2006.toDateTime))
        assertEquals("Feb 2006", february2006.toString(mockResources))

        val march2006=dateTimeInterval.getShiftedDateTimeInterval(2)!!
        assertEquals("01.03.2006 00:00:00.000", dateTimeFormatter.formatJodaDateTime(march2006.fromDateTime))
        assertEquals("31.03.2006 23:59:59.999", dateTimeFormatter.formatJodaDateTime(march2006.toDateTime))
        assertEquals("Mar 2006", march2006.toString(mockResources))

        val december2005=dateTimeInterval.getPreviousDateTimeInterval()!!
        assertEquals("01.12.2005 00:00:00.000", dateTimeFormatter.formatJodaDateTime(december2005.fromDateTime))
        assertEquals("31.12.2005 23:59:59.999", dateTimeFormatter.formatJodaDateTime(december2005.toDateTime))
        assertEquals("Dec 2005", december2005.toString(mockResources))

        val november2005=dateTimeInterval.getShiftedDateTimeInterval(-2)!!
        assertEquals("01.11.2005 00:00:00.000", dateTimeFormatter.formatJodaDateTime(november2005.fromDateTime))
        assertEquals("30.11.2005 23:59:59.999", dateTimeFormatter.formatJodaDateTime(november2005.toDateTime))
